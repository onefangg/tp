...
public class SampleDataUtil {
    ...
    public static Order[] getSampleOrders() {
        return new Order[]{
                new Order(new Remark("No Peanuts"), new Details("Test"), new DeliveryDateTime("25-12-2022 15:30"),
                        CollectionType.DELIVERY,
                        UUID.fromString("6ea390c0-242c-4643-a547-21cc85773f88")),
                new Order(new Remark("Please make delivery by 4pm latest"), new Details("Test2"), new DeliveryDateTime("22-12-2022 16:00"),
                        CollectionType.DELIVERY,
                        UUID.fromString("6ea390c0-242c-4643-a547-21cc85773f88")),
                new Order(new Remark("No candles needed"), new Details("Test3"), new DeliveryDateTime("12-12-2022 12:30"),
